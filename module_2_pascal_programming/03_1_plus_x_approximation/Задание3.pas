var
  ...
  BEGIN
    ...
    write(S,'  ',exp(1/2*ln(abs(x+1))):15,'  ',abs(s-exp(1/2*ln(abs(x+1)))):15,'  ',(abs(s-exp(1/2*ln(abs(x+1)))))/s:15); //вывод полученной суммы, точного значения суммы, абсолютной и относительной ошибки
  end.
